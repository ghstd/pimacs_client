module Monsters
  class Slime < Monsters::BasicClass
    ...
    def initialize(x:, y:, speed: 1, id: nil, respawn_start: nil, respawn_finish: nil)
      ...
      @spell_image = Gosu::Image.new('assets/slime_spell.png')
      @basic_image = Gosu::Image.load_tiles('assets/slime_right.png', $TILE_SIZE, $TILE_SIZE)[0]
    end
